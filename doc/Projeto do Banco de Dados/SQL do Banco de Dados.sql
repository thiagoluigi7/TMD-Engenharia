...
CREATE TABLE IF NOT EXISTS `retrowavedb`.`Locacao` (
  ...
  `idLoc` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`Itens_idItem`, `Cliente_idCliente`, `Funcionario_idFuncionario`, `idLoc`),
...
-- -----------------------------------------------------
-- Table `retrowavedb`.`Jogos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `retrowavedb`.`Jogos` ;

CREATE TABLE IF NOT EXISTS `retrowavedb`.`Jogos` (
...
-- -----------------------------------------------------
-- Table `retrowavedb`.`VideoGames`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `retrowavedb`.`VideoGames` ;

CREATE TABLE IF NOT EXISTS `retrowavedb`.`VideoGames` (
...
INSERT INTO `cliente` (`idCliente`,`nome`,`cpf`,`email`,`telefone`,`senha`,`endereco`)  VALUES (2,'Ciro','22222222222','ciro@ufla.br','11922222222','234','São Paulo'); 
...
INSERT INTO `jogos` (`plataforma`,`Itens_idItem`)  VALUES ('Wii',2); 

-- -----------------------------------------------------
-- Table `retrowavedb`.`VideoGames`
-- -----------------------------------------------------

INSERT INTO `videogames` (`tipo`,`Itens_idItem`)  VALUES ('Blu-Ray',1); 
